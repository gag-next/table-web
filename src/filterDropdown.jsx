...
FilterMenu.propTypes = {
  ...
  column:PropTypes.shape({
    FilterMenuing: PropTypes.string,
    removeFile: PropTypes.string,
    FilterMenuError: PropTypes.string,
    previewFile: PropTypes.string,
    filterMultiple: PropTypes.bool,
    filterDropdown: PropTypes.node,
    filters:PropTypes.arrayOf(PropTypes.shape({ text: PropTypes.string, value: PropTypes.string, children: PropTypes.array})),
